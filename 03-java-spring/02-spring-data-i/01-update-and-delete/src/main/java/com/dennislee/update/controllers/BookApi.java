package com.dennislee.update.controllers;
...
import com.dennislee.update.services.BookService;
...
public class BookApi {
	 ...
	 // Add new book with a POST method
	 ...
	 // Update a current book with a PUT method
